...
// Function to handle Bluetooth configuration update
void handleBluetoothConfig() {
  if (SerialBT.available()) {
    ...
    if (error) {
      Serial.println("Failed to parse Bluetooth JSON");
      return;
    }
...
void setup() {
  ...
  SerialBT.begin("ESP32_BT"); // Initialize Bluetooth Serial
...
void loop() {
  ...
  // Handle Bluetooth configuration update
